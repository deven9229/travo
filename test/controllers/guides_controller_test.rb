...
class GuidesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create guide" do
    assert_difference('Guide.count') do
      post guides_url, params: { guide: { date_of_birth: @guide.date_of_birth, gender: @guide.gender, guide_type: @guide.guide_type, languages: @guide.languages, license: @guide.license, name: @guide.name } }
    end
  ...
  test "should update guide" do
    patch guide_url(@guide), params: { guide: { date_of_birth: @guide.date_of_birth, gender: @guide.gender, guide_type: @guide.guide_type, languages: @guide.languages, license: @guide.license, name: @guide.name } }
